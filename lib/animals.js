...
// Categories: Executive Power, Rule of Law, Economy, Civil Rights,
...
const ANIMAL_MAP = [
  ...
  { match: ["Education & Science"],                              animal: "Owl",           emoji: "🦉", desc: "Wise and curious — knowledge is your superpower." },
  ...
  { match: ["Media & Democracy"],                                animal: "Parrot",        emoji: "🦜", desc: "Vocal and colorful — you make sure the truth gets heard." },
  ...
  { match: ["Environment", "Education & Science"],               animal: "Dolphin",       emoji: "🐬", desc: "Intelligent and playful — you learn your way to a better world." },
  ...
  { match: ["Media & Democracy", "Rule of Law"],                 animal: "Raven",         emoji: "🐦‍⬛", desc: "Clever and perceptive — you see through the noise." },
  { match: ["Economy", "Education & Science"],                   animal: "Beaver",        emoji: "🦫", desc: "Industrious and smart — you build things that last." },
