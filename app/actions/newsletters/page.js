    ...
    >
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }}>
        ...
        <span style={{
          ...
          background: isSubstack ? "rgba(255,102,0,0.1)"   : "rgba(96,165,250,0.1)",
          color:      isSubstack ? "#fb923c"               : "#60a5fa",
          border:     `1px solid ${isSubstack ? "rgba(255,102,0,0.25)" : "rgba(96,165,250,0.25)"}`,
        }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 32px 80px" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase",
            color: "#475569", marginBottom: 10 }}>Stay Informed</div>
          <h1 style={{
            fontFamily: "var(--font-fraunces), Georgia, serif",
            fontSize: "clamp(28px, 4vw, 48px)", fontWeight: 700,
            color: "#F5F1E8", margin: "0 0 12px", letterSpacing: "-0.02em", lineHeight: 1.1,
          }}>Newsletters worth reading</h1>
          <p style={{ fontSize: 14, color: "#64748b", margin: 0, maxWidth: 520, lineHeight: 1.7 }}>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    ...(isUserCat && !isActive ? { color: "#94a3b8" } : {}),
                  }}
                >
                  {cat}
                </button>
        ...
        {/* Loading */}
        {loading && (
          <div style={{ color: "#475569", fontSize: 14, padding: "40px 0" }}>Loading…</div>
        )}
            ...
            <section key={cat} style={{ marginBottom: 56 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 800, letterSpacing: "0.1em",
                  textTransform: "uppercase", color: "#475569" }}>{cat}</span>
        ...
        {!loading && userCats?.length === 0 && browseCat === "all" && (
          <div style={{ textAlign: "center", padding: "60px 0", color: "#475569" }}>
            ...
            <Link href="/onboarding" style={{
              ...
              padding: "9px 20px", borderRadius: 6, background: "#3b82f6",
              textDecoration: "none",
