      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          <span style={{
            ...
            fontSize: 48, fontWeight: 900, color: "#F5F1E8",
            letterSpacing: "-0.04em", display: "block", lineHeight: 1,
          }}>Herd</span>
          <span style={{ fontSize: 14, color: "#4b5563", marginTop: 10, display: "block", letterSpacing: "0.02em" }}>
            Track. Act. Organize.
          </span>
        </div>
        ...
        <p style={{ marginTop: 40, fontSize: 11, color: "#1f2937", textAlign: "center" }}>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div>
            <label style={{ fontSize: 11, fontWeight: 700, color: "#4b5563", textTransform: "uppercase", letterSpacing: "0.1em", display: "block", marginBottom: 6 }}>
              Email
            </label>
            <input
          ...
          <div>
            ...
            <input
              ...
              onBlur={e => e.target.style.borderColor = "rgba(255,255,255,0.1)"}
            />
            {mode === "signup" && <p style={{ fontSize: 11, color: "#374151", marginTop: 5 }}>Minimum 6 characters</p>}
          </div>
          ...
          {success && (
            <div style={{ padding: "10px 14px", borderRadius: 8, fontSize: 13, background: "rgba(34,197,94,0.08)", border: "1px solid rgba(34,197,94,0.2)", color: "#86efac", lineHeight: 1.5 }}>
              {success}
            </div>
          )}
