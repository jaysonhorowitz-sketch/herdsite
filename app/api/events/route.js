...
const CATEGORY_RULES = [
  ...
  { category: "Elections",           keywords: ["election","midterm","ballot","candidate","campaign","canvass","phone bank","voter registration","get out the vote","gotv","poll"] },
  ...
  { category: "Education",           keywords: ["education","school","tutor","literacy","university","college","youth","student","learn","teach"] },
  { category: "Science",             keywords: ["stem","science","research","lab","technology","innovation","climate science"] },
  { category: "Democracy & Media",   keywords: ["democracy","media","press","election","vote","ballot","campaign","canvass","phone bank","transparency"] },
  { category: "Foreign Policy",      keywords: ["foreign policy","diplomacy","international","embassy","un","nato","global","sanctions","treaty"] },
  { category: "Human Rights",        keywords: ["human rights","civil liberties","humanitarian","asylum seeker","refugee","torture","dignity","freedom"] },
